...
> *Lưu ý:* Do dung lượng file dataset vượt quá 100 MB, file được lưu trữ cục bộ trong thư mục `Data` và được cấu hình bỏ qua bởi `.gitignore` theo quy định của GitHub, nếu cần tải về vui lòng liên hệ tôi.
